...
var Puppies = function () {
    ...
    return (React.createElement(Box_1["default"], null,
        ...
        React.createElement(ImageList_1["default"], { sx: { maxHeight: 700 }, key: "list" }, puppies.map(function (puppy) { return (React.createElement(Puppy_1["default"], { puppy: puppy, key: puppy.id })); }))));
};
