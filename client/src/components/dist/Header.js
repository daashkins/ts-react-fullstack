...
var Header = function () {
    return (React.createElement(Box_1["default"], { sx: { flexGrow: 1 } },
        React.createElement(AppBar_1["default"], { position: "sticky", sx: { backgroundColor: '#d26419' } },
            React.createElement(Toolbar_1["default"], { variant: "dense" },
                React.createElement(IconButton_1["default"], { edge: "start", color: "inherit", "aria-label": "menu", sx: { mr: 2 } },
