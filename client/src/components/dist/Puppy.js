...
var Puppy = function (_a) {
    ...
    return (React.createElement(react_card_flip_1["default"], { isFlipped: isFlipped, flipDirection: "vertical" },
        React.createElement(ImageListItem_1["default"], { key: puppy.id },
            React.createElement("img", { src: puppy.image + "?w=248&fit=crop&auto=format", 
                // src={puppy.image}
                srcSet: puppy.image + "?w=248&fit=crop&auto=format&dpr=2 2x", alt: puppy.breed, loading: "lazy" }),
            ...
            React.createElement(Box_1["default"], { sx: { display: "flex", alignItems: "center", justifyContent: "space-between", paddingLeft: 1, paddingRight: 1 } },
                React.createElement(Button_1["default"], { size: "small", onClick: handleClick }, "Learn More"),
                React.createElement(Delete_1["default"], { onClick: function () { return deletePuppy(puppy.id); } }))),
        React.createElement(ImageListItem_1["default"], { key: puppy.id },
            React.createElement("img", { src: puppy.image + "?w=248&fit=crop&auto=format", 
                // src={puppy.image}
                srcSet: puppy.image + "?w=248&fit=crop&auto=format&dpr=2 2x", alt: puppy.breed, loading: "lazy", style: { opacity: '0.5' } }),
            React.createElement(ImageListItemBar_1["default"], { title: puppy.name, position: "below" }),
            React.createElement(Box_1["default"], { sx: { display: "flex", alignItems: "center", justifyContent: "space-between", paddingLeft: 1, paddingRight: 1 } },
                React.createElement(Button_1["default"], { size: "small", onClick: handleClick }, "Back"),
                React.createElement(Delete_1["default"], { onClick: function () { return deletePuppy(puppy.id); } })))));
};
